...
inline bool cmpl(const Rec &x, const Rec &y) { return x.l < y.l; }
inline bool cmpr(const Rec &x, const Rec &y) { return x.r < y.r; }
inline bool cmpm(const Rec &x, const Rec &y) { return x.m < y.m; }
