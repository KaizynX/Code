/*
 * @Author: Kaizyn
 * @Date: 2020-03-13 14:24:50
 * @LastEditors: Kaizyn
 * @LastEditTime: 2020-03-13 15:54:24
 * @FilePath: \Code\Luogu\luogu4783.cpp
 */
#include <bits/stdc++.h>
...
struct Martix {
    ...
    Martix pow(const int &p) const {
        Martix res(n, m), a = *this;
        res.init(1);
        for (int i = p; i; i >>= 1, a *= a) if (i&1) res *= a;
        return res;
    }
    Martix inv() const {
        Martix res = *this;
