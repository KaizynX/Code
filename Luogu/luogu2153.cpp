/*
 * @Author: Kaizyn
 * @Date: 2020-04-13 20:33:11
 * @LastEditTime: 2020-04-13 20:58:57
 */
#include <bits/stdc++.h>
...
signed main()
{
    ...
    int s = n*2+1, t = n*2+2;
    zkw.init(t);
    zkw.add_edge(s, 1, INF, 0);
    zkw.add_edge(n*2, t, INF, 0);
    for (int i = 2; i < n; ++i) {
        zkw.add_edge(s, i*2-1, 1, 0);
        zkw.add_edge(i*2, t, 1, 0);
    }
    for (int i = 1, u, v, w; i <= m; ++i) {
        cin >> u >> v >> w;
        zkw.add_edge(u*2-1, v*2, 1, w);
    }
