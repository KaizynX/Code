/*
 * @Author: Kaizyn
 * @Date: 2021-07-13 13:43:50
 * @LastEditTime: 2021-07-13 15:44:43
 */
#include <bits/stdc++.h>
...
struct SegmentTree {
  ...
  int *a, n;
  TreeNode push_up(const TreeNode &lc, const TreeNode &rc) {
    return TreeNode {
        lc.s+rc.s,
  ...
  TreeNode query(int L, int R, int l, int r, int i) {
    ...
    return push_up(query(L, R, l, mid, i<<1), query(L, R, mid+1, r, i<<1|1));
  }
};
