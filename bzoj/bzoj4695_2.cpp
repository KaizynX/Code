 ...
 * @LastEditTime: 2021-02-22 20:00:58
 */
#include <bits/stdc++.h>
  ...
  void push_down(int o)
	{
		...
		push_tag(lc, tr[lc].mn1==mn?tr[o].tag1:tr[o].tag3,
		    tr[lc].mx1==mx?tr[o].tag2:tr[o].tag3, tr[o].tag3);
		push_tag(rc, tr[rc].mn1==mn?tr[o].tag1:tr[o].tag3,
		    tr[rc].mx1==mx?tr[o].tag2:tr[o].tag3, tr[o].tag3);
		tr[o].tag1=tr[o].tag2=tr[o].tag3=0;
	}
  */
...
signed main() {
	freopen("D:\\tmp\\15.in", "r", stdin);
	freopen("D:\\tmp\\test.out", "w", stdout);
  read(n);
