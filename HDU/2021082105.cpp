/*
 * @Author: Kaizyn
 * @Date: 2021-08-21 14:44:45
 * @LastEditTime: 2021-08-21 15:11:52
 */
#include <bits/stdc++.h>
...
struct generalSAM {
  ...
  int t[M], rk[M], tr[M], ed[M], fa[M][LOGN];
  generalSAM() { init(); }
  void init() {
