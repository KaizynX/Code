/*
 * @Author: Kaizyn
 * @Date: 2021-08-12 13:09:36
 * @LastEditTime: 2021-08-12 14:16:43
 */
...
struct Aho_Corasick_Automaton {
  ...
  char beg;
  int nex[NN][SZ], /*num[NN],*/ fail[NN], ext[NN], cnt;
  int vis[NN], res[NN][31], dpp[N][31];
