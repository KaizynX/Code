/*
 * @Author: Kaizyn
 * @Date: 2021-08-28 16:38:18
 * @LastEditTime: 2021-08-28 16:48:04
 */
...
struct Martix {
  ...
  friend Martix operator * (const Martix &m1, const Martix &m2) {
    ...
    res.a[1][1] = (m1.a[1][1]*m2.a[1][1]+m1.a[1][2]*m2.a[2][1])%MOD;
    res.a[1][2] = (m1.a[1][1]*m2.a[1][2]+m1.a[1][2]*m2.a[2][2])%MOD;
    res.a[2][1] = (m1.a[2][1]*m2.a[1][1]+m1.a[2][2]*m2.a[2][1])%MOD;
    res.a[2][2] = (m1.a[2][1]*m2.a[1][2]+m1.a[2][2]*m2.a[2][2])%MOD;
    return res;
  }
